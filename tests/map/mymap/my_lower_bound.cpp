...
int main()
{
	...
	for (ft::map<std::string, int>::iterator it = a_map.lower_bound(std::string("Moscow")); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<std::string, int>::iterator it = a_map.lower_bound(std::string("Ben_guerir")); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<std::string, int>::iterator it = a_map.lower_bound(std::string("Quebec")); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<std::string, int>::iterator it = a_map.lower_bound(std::string("Brussels")); it != a_map.lower_bound(std::string("Quebec")); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "do: printing from lower_bound on \"Moscow\" to the end:" E << std::endl;
	for (ft::map<std::string, int>::const_iterator it = const_a_map.lower_bound(std::string("Moscow")); it != const_a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_a_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on \"Ben_guerir\" to the end:" E << std::endl;
	for (ft::map<std::string, int>::const_iterator it = const_a_map.lower_bound(std::string("Ben_guerir")); it != const_a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_a_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on \"Quebec\" to the end:" E << std::endl;
	for (ft::map<std::string, int>::const_iterator it = const_a_map.lower_bound(std::string("Quebec")); it != const_a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_a_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on \"Brussels\" to lower_bound on \"Quebec\":" E << std::endl;
	for (ft::map<std::string, int>::const_iterator it = const_a_map.lower_bound(std::string("Brussels")); it != const_a_map.lower_bound(std::string("Quebec")); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_a_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<int, std::string>::iterator it = z_map.lower_bound(4329); it != z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<int, std::string>::iterator it = z_map.lower_bound(88); it != z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<int, std::string>::iterator it = z_map.lower_bound(60148); it != z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	std::cout << std::endl;
	...
	for (ft::map<int, std::string>::iterator it = z_map.lower_bound(365); it != z_map.lower_bound(10751); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on 4329 to the end:" E << std::endl;
	for (ft::map<int, std::string>::const_iterator it = const_z_map.lower_bound(4329); it != const_z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_z_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on 88 to the end:" E << std::endl;
	for (ft::map<int, std::string>::const_iterator it = const_z_map.lower_bound(88); it != const_z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_z_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on 60148 to the end:" E << std::endl;
	for (ft::map<int, std::string>::const_iterator it = const_z_map.lower_bound(60148); it != const_z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_z_map.size() << E;
	std::cout << std::endl;
	...
	std::cout << BOLD "Proto 1: function lower_bound CONST" E << std::endl;
	std::cout << BOLD "do: printing from lower_bound on 365 to lower_bound on 10751:" E << std::endl;
	for (ft::map<int, std::string>::const_iterator it = const_z_map.lower_bound(365); it != const_z_map.lower_bound(10751); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_z_map.size() << E;
	std::cout << std::endl;
	return (0);
