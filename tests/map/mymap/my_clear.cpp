...
int main()
{
	...
	std::cout << BLUE "/* Erases all elements from the container. ********************************** */" E << std::endl;
	std::cout << BLUE "/* After this call, size() returns zero. ************************************ */" E << std::endl;
	std::cout << BLUE "/* ************************************************************************** */" E << std::endl;
	std::cout << std::endl;
	...
	std::cout << std::endl;
	std::cout << BOLD "do: clear on an empty map: " E << std::endl;
	a_map.clear();
	...
	std::cout << std::endl;
	std::cout << BOLD "do: clear an non empty map: " E << std::endl;
	a_map.clear();
	std::cout << "a_map is:" << std::endl;
	for (ft::map<std::string, int>::iterator it = a_map.begin(); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
