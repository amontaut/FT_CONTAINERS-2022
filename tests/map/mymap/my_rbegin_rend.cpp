...
int main()
{
	...
	for (ft::map<std::string, int>::reverse_iterator it = a_map.rbegin(); it != a_map.rend(); ++it)
	...
	for (ft::map<std::string, int>::const_reverse_iterator it = const_a_map.rbegin(); it != const_a_map.rend(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	std::cout << "a_map is (empty map):" << std::endl;
	for (ft::map<int, std::string>::reverse_iterator it = z_map.rbegin(); it != z_map.rend(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	for (ft::map<int, std::string>::const_reverse_iterator it = const_z_map.rbegin(); it != const_z_map.rend(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
