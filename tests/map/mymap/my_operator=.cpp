...
int main()
{
	...
	for (ft::map<std::string, int>::iterator it = b_map.begin(); it != b_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	for (ft::map<int, std::string>::iterator it = w_map.begin(); it != w_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
