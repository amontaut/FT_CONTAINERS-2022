...
int main()
{
	...
	std::cout << std::endl;
	std::map<std::string, int> other_map;
	other_map["Canada"] = 1;
	other_map["Russia"] = 7;
	...
	a_map.insert(std::pair<std::string, int>("Lyon", 42));
	...
	a_map.insert(a_map.begin(), std::pair<std::string, int>("Paris", 42));
	std::cout << "a_map is :" << std::endl;
	for (std::map<std::string, int>::iterator it = a_map.begin(); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	...
	a_map.insert(a_map.end(), std::pair<std::string, int>("Kazan", 21));
	std::cout << "a_map is :" << std::endl;
	for (std::map<std::string, int>::iterator it = a_map.begin(); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	...
	std::cout << std::endl;
	std::map<int, std::string> z_other_map;
	...
	z_map.insert(std::pair<int, std::string>(88, "Mercure"));
	...
	z_map.insert(z_map.begin(), std::pair<int, std::string>(4329, "Jupiter"));
	std::cout << "z_map is :" << std::endl;
	for (std::map<int, std::string>::iterator it = z_map.begin(); it != z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	...
	z_map.insert(z_map.end(), std::pair<int, std::string>(30664, "Uranus"));
	std::cout << "z_map is :" << std::endl;
	for (std::map<int, std::string>::iterator it = z_map.begin(); it != z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
