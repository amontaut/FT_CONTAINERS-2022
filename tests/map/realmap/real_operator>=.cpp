...
int main()
{
	...
	if (a_map >= a_other)
		...
		std::cout << RED "Contents of a_map are lexicographically less to the contents of a_other" E << std::endl;
	...
	if (z_map >= z_other)
		...
		std::cout << RED "Contents of z_map are lexicographically less to the contents of z_other" E << std::endl;
