...
int main()
{
	...
	for (std::map<std::string, int>::iterator it = a_map.find("Here"); it != a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	std::cout << std::endl;
	...
	std::map<std::string, int> const_a_map;
	const_a_map = a_map;
	std::cout << "const_a_map is:" << std::endl;
	for (std::map<std::string, int>::iterator it = const_a_map.begin(); it != const_a_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	std::cout << BOLD "do: find word \"here\" (not in the map): " E << std::endl;
	for (std::map<std::string, int>::iterator it = const_a_map.find("Here"); it != const_a_map.find("Here"); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_a_map.size() << E;
	std::cout << std::endl;
	...
	for (std::map<int, std::string>::iterator it = z_map.find(99); it != z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	std::cout << std::endl;
	...
	std::map<int, std::string> const_z_map;
	const_z_map = z_map;
	std::cout << "const_z_map is:" << std::endl;
	for (std::map<int, std::string>::iterator it = const_z_map.begin(); it != const_z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	std::cout << BOLD "Proto 1: function find CONST" E << std::endl;
	std::cout << BOLD "do: find word 99 (not in the map): " E << std::endl;
	for (std::map<int, std::string>::iterator it = const_z_map.find(99); it != const_z_map.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	std::cout << ITGREY " Size is: " << const_z_map.size() << E;
	std::cout << std::endl;
