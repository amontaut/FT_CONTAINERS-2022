...
/* ************************************************************************** */
/* Test for the non-member function swap ************************************ */
...
int main()
{
	...
	std::cout << std::endl;
	std::map<std::string, int> c_other;
	c_other["Alice"] = 25;
	std::cout << "c_other is :" << std::endl;
	for (std::map<std::string, int>::iterator it = c_other.begin(); it != c_other.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	std::cout << std::endl;
	std::map<std::string, int> d_other;
	std::cout << "d_other is (empty map):" << std::endl;
	for (std::map<std::string, int>::iterator it = d_other.begin(); it != d_other.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	std::cout << std::endl;
	std::map<int, std::string> y_other;
	y_other[25] = "Alice";
	std::cout << "y_other is :" << std::endl;
	for (std::map<int, std::string>::iterator it = y_other.begin(); it != y_other.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
	...
	x_map[75020] = "Belleville";
	x_map[75005] = "St Germain";
	x_map[75017] = "Batignolles";
	x_map[75001] = "Louvre";
	...
	std::cout << std::endl;
	std::map<int, std::string> x_other;
	std::cout << "x_other is (empy map)" << std::endl;
	for (std::map<int, std::string>::iterator it = x_other.begin(); it != x_other.end(); ++it)
		std::cout << it->first << "   " << it->second << std::endl;
