...
int main()
{
	...
	std::cout << std::endl;
	std::cout << "max_size of a_map is (empty map): " << a_map.max_size();
	std::cout << std::endl;
	...
	std::cout << ITGREY " Size is: " << a_map.size() << E;
	std::cout << std::endl;
	std::cout << "max_size of a_map is: " << a_map.max_size();
	std::cout << std::endl;
	...
	std::cout << "max_size of z_map is (empty map): " << z_map.max_size();
	std::cout << std::endl;
	...
	std::cout << ITGREY " Size is: " << z_map.size() << E;
	std::cout << std::endl;
	std::cout << "max_size of a_map is: " << z_map.max_size();
	std::cout << std::endl;
