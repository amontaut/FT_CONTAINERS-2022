...
int main()
{
	...
	if (a_stack <= a_other)
		std::cout << RED "Contents of a_stack are lexicographically less or equal to the contents of a_other" E << std::endl;
	else
	...
	if (z_stack <= z_other)
		std::cout << RED "Contents of z_stack are lexicographically less or equal to the contents of z_other" E << std::endl;
	else
