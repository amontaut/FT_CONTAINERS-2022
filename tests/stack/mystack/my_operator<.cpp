...
int main()
{
	...
	if (a_stack < a_other)
		std::cout << RED "Contents of a_stack are lexicographically less than the contents of a_other" E << std::endl;
	else
		std::cout << GREEN "Contents of a_stack are lexicographically greater than or equal to the contents of a_other" E << std::endl;
	...
	if (z_stack < z_other)
		std::cout << RED "Contents of z_stack are lexicographically less than the contents of z_other" E << std::endl;
	else
		std::cout << GREEN "Contents of z_stack are lexicographically greater than or equal to the contents of z_other" E << std::endl;
