...
/*   Updated: 2022/09/26 11:06:15 by amontaut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << BLUE "/* Test for the member function back **************************************** */" E << std::endl;
	std::cout << BLUE "/* Returns reference to the last element in the container. ****************** */*/" E << std::endl;
	std::cout << BLUE "/* ************************************************************************** */" E << std::endl;
	...
	std::cout << BOLD "Proto 1: function back NOT CONST" E << std::endl;
	...
	std::cout << "back value is: " << a_vector.back() << ITGREY " || size is: " << a_vector.size() /* << " || capacity is: " << a_vector.capacity() */ << E << std::endl;
	std::cout << std::endl;
	...
	std::cout << "back value is: " << const_a_vector.back() << ITGREY " || size is: " << const_a_vector.size() /* << " || capacity is: " << const_a_vector.capacity() */ << E << std::endl;
	std::cout << std::endl;
	...
	std::cout << "back value is: " << z_vector.back() << ITGREY " || size is: " << z_vector.size() /* << " || capacity is: " << a_vector.capacity() */ << E << std::endl;
	std::cout << std::endl;
	...
	std::cout << "back value is: " << const_z_vector.back() << ITGREY " || size is: " << const_z_vector.size() /* << " || capacity is: " << a_vector.capacity() */ << E << std::endl;
	std::cout << std::endl;
