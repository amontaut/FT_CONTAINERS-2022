...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   real_swap_non_member.cpp                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: amontaut <amontaut@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/16 16:35:46 by amontaut          #+#    #+#             */
/*   Updated: 2022/09/26 12:02:46 by amontaut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << BLUE "/* Test for the non-member function swap ************************************ */" E << std::endl;
	...
	for (std::vector<int>::iterator it = c_vector.begin(); it != c_vector.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << ITGREY " || size is: " << c_vector.size()/* << " || capacity is: " << z_vector.capacity() */ << E;
	std::cout << std::endl;
	std::vector<int> c_other;
	c_other.push_back(42);
	std::cout << "c_other is :" << std::endl;
	for (std::vector<int>::iterator it = c_other.begin(); it != c_other.end(); ++it)
		std::cout << ' ' << *it;
	...
	for (std::vector<int>::iterator it = d_vector.begin(); it != d_vector.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << ITGREY " || size is: " << d_vector.size()/* << " || capacity is: " << d_vector.capacity() */ << E;
	std::cout << std::endl;
	std::vector<int> d_other;
	std::cout << "d_other is (empty vector):" << std::endl;
	for (std::vector<int>::iterator it = d_other.begin(); it != d_other.end(); ++it)
		std::cout << ' ' << *it;
	...
	std::cout << std::endl;
	std::vector<std::string> y_vector;
	std::cout << "y_vector is (empty vector):" << std::endl;
	for (std::vector<std::string>::iterator it = y_vector.begin(); it != y_vector.end(); ++it)
		std::cout << ' ' << *it;
	std::cout << ITGREY " || size is: " << y_vector.size()/* << " || capacity is: " << y_vector.capacity() */ << E;
	std::cout << std::endl;
	std::vector<std::string> y_other;
	y_other.push_back("Moon");
	std::cout << "y_other is :" << std::endl;
	for (std::vector<std::string>::iterator it = y_other.begin(); it != y_other.end(); ++it)
		std::cout << ' ' << *it;
