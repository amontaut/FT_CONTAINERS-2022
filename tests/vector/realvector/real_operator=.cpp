...
/*   Updated: 2022/09/26 11:44:17 by amontaut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	for (std::vector<int>::iterator it = b_vector.begin(); it != b_vector.end(); ++it)
		std::cout << ' ' << *it;
	...
	for (std::vector<std::string>::iterator it = w_vector.begin(); it != w_vector.end(); ++it)
		std::cout << ' ' << *it;
