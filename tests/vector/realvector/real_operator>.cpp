...
/*   Updated: 2022/09/26 11:52:37 by amontaut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	if (a_vector > a_other)
		...
		std::cout << RED "Contents of a_vector are lexicographically less than or equal to the contents of a_other" E << std::endl;
	...
	if (z_vector > z_other)
		...
		std::cout << RED "Contents of z_vector are lexicographically less than or equal to than the contents of z_other" E << std::endl;
