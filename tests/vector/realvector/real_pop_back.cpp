...
/*   Updated: 2022/09/26 11:55:04 by amontaut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << BLUE "/* Test for the member function pop_back ************************************ */" E << std::endl;
	...
	std::cout << std::endl;
	std::cout << BOLD "do: pop_back: " E << std::endl;
	a_vector.pop_back();
	std::cout << "a_vector is:" << std::endl;
	for (std::vector<int>::iterator it = a_vector.begin(); it != a_vector.end(); ++it)
		std::cout << ' ' << *it;
	...
	std::cout << std::endl;
	std::cout << BOLD "do: remove all values using pop_back in a loop: " E << std::endl;
	for (int i = a_vector.size(); i > 0; i--)
		a_vector.pop_back();
	std::cout << "a_vector is:" << std::endl;
	for (std::vector<int>::iterator it = a_vector.begin(); it != a_vector.end(); ++it)
		std::cout << ' ' << *it;
