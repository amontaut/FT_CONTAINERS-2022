...
int main()
{
	...
	for (std::vector<int>::reverse_iterator it = a_vector.rbegin(); it != a_vector.rend(); ++it)
		std::cout << ' ' << *it;
	...
	for (std::vector<int>::const_reverse_iterator it = const_a_vector.rbegin(); it != const_a_vector.rend(); ++it)
		std::cout << ' ' << *it;
	...
	std::cout << "a_vector is (empty vector):" << std::endl;
	for (std::vector<std::string>::reverse_iterator it = z_vector.rbegin(); it != z_vector.rend(); ++it)
		std::cout << ' ' << *it;
	...
	for (std::vector<std::string>::const_reverse_iterator it = const_z_vector.rbegin(); it != const_z_vector.rend(); ++it)
		std::cout << ' ' << *it;
